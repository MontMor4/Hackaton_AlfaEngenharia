      ...
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10} pt={6}>
        <Stack spacing={4}>
          ...
          <Text color={"gray.500"} fontSize={"lg"}>
            Uma empresa que preza pela excelência na execução de ideias e
            projetos, sendo a melhor solução CUSTOMIZADA para nossos CLIENTES!
          </Text>
          <Stack
            spacing={4}
            divider={
        ...
        <Flex>
          <Image
            rounded={"md"}
            alt={"feature image"}
            src={"https://source.unsplash.com/VLPUm5wP5Z0"}
            objectFit={"cover"}
          />
        </Flex>
      </SimpleGrid>
